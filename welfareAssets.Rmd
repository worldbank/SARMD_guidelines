...
In microeconomics, an Engel curve describes how household expenditure on a good or service varies with household's purchasing power. For normal goods, the Engel curve has a positive gradient. That is, as purchasing power increases, the quantity of assets demanded increases. For inferior goods, the Engel curve has a negative gradient. Both Engel curves in \@ref(fig:engel) are upward sloping, but one bends toward the X-axis for necessities and the other towards the Y-axis for luxury goods.
