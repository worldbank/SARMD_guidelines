...
[PovcalNet](http://iresearch.worldbank.org/PovcalNet/home.aspx) is an interactive computational tool that allows you to replicate the calculations made by the World Bank's researchers in estimating the extent of absolute poverty in the world. The poverty and inequality measures provided by [PovcalNet](http://iresearch.worldbank.org/PovcalNet/home.aspx) for South Asia are described in Table \@ref(tab:povcalnet) and may be accessed by interacting with Figure \@ref(fig:povcalnetdata):
