...
```{r psprfg, echo=FALSE, fig.cap = "share of poor population in SAR allocated by country", fig.align = 'left'}
# par(mfrow=c(1,2))
# 
# # Simple Pie Chart
...
The World Bank’s poverty and inequality measures for South Asia provided by [PovcalNet](http://iresearch.worldbank.org/PovcalNet/home.aspx) are described in Table \@ref(tab:povcalnet) and may be accessed by interacting with figure \@ref(fig:povcalnetdata):
...
A summary of PovcalNet data can be seen in Figure \@ref(fig:povcalnetdata):
