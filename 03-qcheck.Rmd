...
The essential variables that identify each dataset and should always be included are countrycode, year, survey, vermast, veralt, idh, and idp. Weights are defined as wgt and pop_wgt=wgt*hsize. The dates of the survey are recorded as int_year and int_month. The geographical location within the country’s administrative division is recorded as subnatid1, and in some cases, subnatid2 may provide a more specific location. 
psu 
strata 
spdef 
...
Household size is close to seven in Afghanistan, Pakistan and Maldives, and much closer to 4-5 in the rest of the countries. Population pyramids such as the one provided in Figure ?? allow to see how countries’ demographics change over time while showing whether the marital status of individuals has been harmonized adequately. 
