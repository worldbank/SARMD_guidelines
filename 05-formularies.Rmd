...
Household surveys capture a wide variety of development indicators in such areas as poverty, food security, labor market performance, demography, education, health, gender equality, housing and agriculture. In this chapter, we present the results of a Metadata analysis focusing mostly on the household surveys' ability to measure food consumption and other expenditures through different data collection methods. In South Asia, poverty is defined as the inability of an individual to command sufficient resources to satisfy basic needs defined by the poverty line. In order to provide information on poverty and food security among the population, a nominal consumption aggregate is needed. The characteristics of each household survey and their ability to construct a nominal consumption aggregate were collected by filling a Metadata formulary (see attached?).
