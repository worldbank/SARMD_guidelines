...
food <- readr:: read_csv("./tables/food.csv", col_types = readr::cols()) 
...
nonfood <- readr:: read_csv("./tables/nonfood.csv", col_types = readr::cols()) 
...
durables <- readr:: read_csv("./tables/durables.csv", col_types = readr::cols()) 
...
housing <- readr:: read_csv("./tables/housing.csv", col_types = readr::cols()) 
