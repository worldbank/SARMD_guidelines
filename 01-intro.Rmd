...
The World Bank’s poverty measures for South Asia provided by [PovcalNet](http://iresearch.worldbank.org/PovcalNet/home.aspx) are shown in the following figure. PovcalNet provides headcount ratios, poverty gaps, squared poverty gaps, Gini coefficients, among other measures. **The user may interact with this Tableau dashboard by clicking on the figure below.**

[![](figures/Povcalnet.png)](https://tab.worldbank.org/#/site/WBG/views/SAR_MNA_Poverty/PovcalNet)
