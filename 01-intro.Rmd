...
The World Bank’s poverty measures provided by [PovcalNet](http://iresearch.worldbank.org/PovcalNet/home.aspx) are shown in Figure A below:

```{r povcalnet, echo=FALSE, fig.cap='[A. PovcalNet](https://tab.worldbank.org/#/site/WBG/views/SAR_MNA_Poverty/PovcalNet)', fig.align='center'}
knitr::include_graphics("figures/Povcalnet.png")
```
