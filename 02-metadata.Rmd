...
This chapter provides an overview of household surveys metadata in SAR and MNA with the support of a series of accompanying Tableau dynamic dashboards. The South Asia Micro Database (SARMD) consists of raw household survey data, documentation, questionnaires, and a repository of do files to reconstruct harmonized variables, consumption aggregates, and poverty estimates. SARMD currently includes the eight countries in the region, contemplates forty-three surveys, and contains close to a hundred harmonized variables covering the 1993-2017 period. Table xx shows the latest available household surveys in SARMD. 
...
The first is food expenditures, include food consumed by households from purchases, home production and transfers. This is sometimes thought to be easier to measure than non-food. When household members eat from a common pot, it is common to find a single well-informed individual who can act as respondent. Surveys typically combine a household expenditure diary, however, this is not common in South Asia where most information on food is collected based on weekly recalling what a household has consumed and purchased. 

The ideal reference period should be a week (reference), but in this analysis we have found reference periods still vary from monthly to biweekly to daily. In recent years, the Indian National Sample Survey Organization has experimented with  7-day and 30-day recall periods for a number of items, and discovered that the 7-day recall cuts Indian poverty rates by half, removing some 200 million people from dollar-a-day poverty. This is an issue that has not been much investigated by LSMS surveys, but has recently moved into the forefront of research. 

In many (but not all) surveys, households report both quantities and expenditures for most of the foods they purchase (e.g. three kilograms of rice for 5 rupees). The food component should include food produced and consumed at home, as well as consumed outside the home, such as at restaurants, cafés, etc. Food transfers are currently measured unevenly with different collection methods and for unsteady baskets of goods. 

Food baskets and their collection periods vary even within the same country over time. 
...
The second component, non-food expenditures, includes frequently purchased goods and services like soap, cleaning supplies, newspapers, and personal care items. It also includes somt less frequently but regularly purchases items like clothing, footwear, kitchen equipment, curtains, bedcovers, etc. 

Similarly to what found studying the food component, non-food items are also collected for different reference periods, for example, from consumption in the last 30 days, past 3 months, or the last year. 
...
The third component is consumer flows from durable goods that deliver useful services to a consumer through repeated use over an extended period of time. 
...
The fourth component is rent, which is obtained either by asking how much would you expect to receive each month for this house if you rented it out to someone, or by using a hedonic housing regression model based on dwelling characteristics and actual rent. Imputations are often quite suspect—for example, those for imputed rent for owner-occupiers in an economy where house tenancy is very rare.
