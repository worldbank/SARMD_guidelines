...
This book is written in [R Markdown](https://rmarkdown.rstudio.com/) syntax and compiled with the [bookdown](https://bookdown.org/yihui/bookdown/) package. The source files are available in the World Bank Github repository [DDDD](https://github.com/randrescastaneda/SARMD_guidelines). To become a contributor to this project, please send an email to ... requesting for access. Once you are granted access, you may clone or fork this repository and start contributing. 
