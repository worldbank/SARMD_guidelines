...
local controls "i.male age age_squared hsize i.urban i. electricity i.ownhouse i.subnatid1"
...
```{r bgd_model1}
bgd_model1 <- read_csv("./tables/Regressions/model1_linear_BGD.csv")
knitr::kable(bgd_model1, caption = 'Linear regression: Dependent variable ln_welfare_perc')
```

```{r bgd_model2, echo=FALSE, warning=FALSE, eval=TRUE, error=FALSE, results='markup', tidy=TRUE, cache=FALSE}
bgd_model2 <- read_csv("./tables/Regressions/model2_logit_BGD.csv")
knitr::kable(bgd_model2,booktabs=TRUE, caption = 'Logit regression: Dependent variable poor_int')
```
