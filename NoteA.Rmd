...
The effect of endowment accumulation shows the mean change in poverty rate when explanatory indicators in previous year have the same characteristics as the ones in the next period. The estimates in table \@ref(tab:decomp) of -0.33, -2.51, and -1.66 for Pakistan, Bhutan, and Bangladesh, respectively, indicate that changes in literacy, gender, labor force status, and sector employment contributed to the decrease in poverty rates. 
 
Coefficient terms indicate the estimated change in poverty rate in a previous year when the coefficients in later period are applied to the indicators in the previous year (**This sentence is not clear**). Returns to endowment largely impacted on the decline. In Pakistan, for example, endowment accumulation triggered poverty reduction by 0.33 percentage point whereas return to endowment lowered the poverty rate by 10.17 percentage points, 5 times higher than endowment effect.  
