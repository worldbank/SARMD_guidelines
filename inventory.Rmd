...
```{r inv, echo=FALSE, eval=FALSE, fig.cap='[SARMD Inventory](https://tab.worldbank.org/#/site/WBG/views/SAR_MNA_Metadata/Availability)', fig.align='center'}
knitr::include_graphics("./figures/Inventory.png")
```

[![](figures/Inventory.png)](https://tab.worldbank.org/#/site/WBG/views/SAR_MNA_Metadata/Availability "Number of surveys available in SARMD by country.")
...
```{r ssize, echo=FALSE, eval=FALSE, fig.cap='[Sample Size](https://tab.worldbank.org/#/site/WBG/views/SAR_MNA_Metadata/Lines)', fig.asp=.75, fig.align='center'}
knitr::include_graphics("./figures/Survey_size.png")
```

[![](figures/Survey_size.png)](https://tab.worldbank.org/#/site/WBG/views/SAR_MNA_Metadata/Lines "Survey size")
