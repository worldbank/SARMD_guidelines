...
You may be wondering how does this compare to other regions of the world? Figures \@ref(fig:inventory3) and \@ref(fig:inventory4) provide the number of surveys that have been added to GMD over the last ten years. The answer is that compared to ECA and LAC, where most of the countries produce yearly or biannual househod surveys, the rest of the developing world is very close to extreme data deprivation (dangerously close to less than two data points in a ten-year period).[^ExCountries]
