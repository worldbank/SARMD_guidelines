...
cd "${hostdrive}\SOUTH ASIA MICRO DATABASE\05.projects_requ\01.SARMD_Guidelines\02. qcheck\02. sar qcheck\09. shareable do-files\Javier_Note1_Final\" 
...
order country year ctryear
save "data.dta", replace
export excel using "atschool_analysis.xls", firstrow(variables) replace
exit 
/* End of do-file */
