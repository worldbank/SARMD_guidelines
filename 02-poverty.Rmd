...
library(readr)
pspr <- read_csv("~/SARMD_User_Guidelines/SARMD_guidelines/tables/pspr.csv",col_names = TRUE, col_types = cols())
...
library(readr)
povcalnet <- read_csv("~/SARMD_User_Guidelines/SARMD_guidelines/tables/povcalnet.csv",col_names = TRUE, col_types = cols())
